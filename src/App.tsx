    ...
    <main className="app-shell">
      <section className="hero-card">
        <div className="hero-copy">
          ...
          <h1>Школьная версия на тетрадном листе</h1>
          <p className="hero-text">
            Пара подходит, если цифры равны или дают сумму 10, а между ними в
            строке, столбце или по порядку чтения через перенос строки только
            пустота из зачёркнутых клеток.
          </p>
        </div>
        <ControlPanel
